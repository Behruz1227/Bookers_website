  ...
  return (
    <div>
      ...
      <UniversalModal
        ...
        style=""
      >
        <div className="w-full grid place-items-center px-[2%] my-3 mb-10">
          <h1 className="font-semibold lg:text-1xl text-xl text-center pb-4">
            {t(
              "Пожалуйста, заполните форму ниже для рассмотрения вашей кандидатуры. Прикрепите ваше резюме и, при необходимости, другие документы, подтверждающие вашу квалификацию."
            )}
          </h1>
          <div className="grid grid-cols-1 lg:grid-cols-2 justify-center  gap-y-4 lg:gap-6 w-full my-6 px-[2%]">
            ...
            <div className="col-start-1 col-end-3 flex flex-col lg:flex-row gap-3">
              <div className=" mx-auto lg:mx-0 flex flex-col lg:items-start items-center">
                <label
                  htmlFor="phoneNumber"
                  className={`block  ${
                    errors.file1 ? "text-red-500" : "text-gray-700"
                  } font-medium mb-2`}
                >
                  {t("Резюме*")}
                </label>
                <div
                  className="max-w-[200px] px-6 py-1  border-2 border-[#9C0B35] rounded-full flex items-center justify-between"
              ...
              <div className=" mx-auto lg:mx-0 flex flex-col lg:items-start  items-center">
                <label
                  htmlFor="phoneNumber"
                  className={`block ${
                    errors.file2 ? "text-red-500" : "text-gray-700"
                  } font-medium mb-2`}
                >
                  {t("Дополнительные документы")}
                </label>
                <div
                  className="px-6 py-1 max-w-[200px] border-2 border-[#9C0B35] rounded-full flex items-center justify-between"
          ...
          <div>
            <button
              ...
              className={`mt-4 py-2 md:py-3 px-8 md:px-10 rounded-full  ${
                !status ? "bg-[#9C0B35] text-white" : "bg-[#d12253] text-white0"
              }`}
            >
