...
import OvalImage from '../../assets/cards/Oval.png'; // Rasmni import qilish
...
export const TestimonialCard: React.FC<TestimonialCardProps> = ({
  ...
  return (
    <Card
      className="max-w-md w-[370px] h-[339px] rounded-3xl shadow-lg p-2"
      style={{
    ...
    >
      <div className="relative">
        <div className="flex items-start gap-4">
          <div className="relative ">
            <Avatar
              src={OvalImage} // Rasmni Avatar-da ishlatish
              size={48}
              className="shadow-sm"
            />
        ...
        >
          ...
          <span style={{ color: '#9C0B35' }}>{company}</span>
        </div>
      </div>
    </Card>
  );
